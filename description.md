...
- **Board as the single status channel:** Backlog → Planned → Todo → Doing → Done plus Question; comments are the log, columns are the signal, and only a human ever moves a card into Todo.
